  ...
  return (
    <main style={{ maxWidth: 720, margin: "0 auto", padding: "3rem 1.5rem" }}>
      ...
      <p style={{ color: "#94a3b8", lineHeight: 1.6 }}>
        Network: <strong>{network}</strong> | Deploy target:{" "}
        <strong>__DEPLOY_TARGET__</strong>
      </p>
      ...
      >
        ...
        <p>
          <code>GET /api/my-service</code> with header{" "}
          <code>x-payment-ref</code> after creating a quote.
        </p>
      </section>
    </main>
  );
