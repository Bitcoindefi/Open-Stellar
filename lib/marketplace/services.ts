...
export type ServiceCapability =
  "data" | "comms" | "processing" | "defense" | "research";
...
const baseServices: Array<Omit<MarketplaceService, "providerAgent">> = [
    ...
    receiptHistory: [
      {
        ...
        agent: "bot-0",
        amountXlm: 0.08,
        settledAt: "2026-06-25T15:22:11Z",
        latencyMs: 128,
      },
      {
        id: "rcpt_oracle_1041",
        agent: "bot-8",
        amountXlm: 0.08,
        settledAt: "2026-06-25T14:47:02Z",
        latencyMs: 151,
      },
    ],
    uptime: [
      { label: "Mon", value: 99.9 },
      { label: "Tue", value: 99.8 },
      { label: "Wed", value: 100 },
      { label: "Thu", value: 99.7 },
    ...
    receiptHistory: [
      {
        ...
        agent: "bot-1",
        amountXlm: 0.03,
        settledAt: "2026-06-25T13:18:44Z",
        latencyMs: 83,
      },
      {
        id: "rcpt_relay_777",
        agent: "bot-6",
        amountXlm: 0.03,
        settledAt: "2026-06-25T12:51:30Z",
        latencyMs: 91,
      },
    ],
    uptime: [
      { label: "Mon", value: 99.5 },
      { label: "Tue", value: 99.7 },
      { label: "Wed", value: 99.4 },
      { label: "Thu", value: 99.9 },
      { label: "Fri", value: 99.6 },
    ],
  },
  {
    ...
    description:
      "Queue-backed processing service for embeddings, classification, and summarization jobs.",
    priceXlm: 0.22,
    district: "processing",
    ...
    reputationScore: 902,
    docs: [
      "Submit compact JSONL batches for deterministic inference.",
      "Each job returns per-item usage and receipt IDs.",
    ],
    exampleRequest: {
      task: "summarize",
      inputs: ["receipt one", "receipt two"],
      maxTokens: 120,
    },
    exampleResponse: {
      jobId: "job_bif_41",
      status: "complete",
      outputs: ["2 receipt summaries"],
    },
    receiptHistory: [
      {
        id: "rcpt_forge_512",
        agent: "bot-2",
        amountXlm: 0.22,
        settledAt: "2026-06-25T11:05:21Z",
        latencyMs: 611,
      },
      {
        id: "rcpt_forge_511",
        agent: "bot-7",
        amountXlm: 0.22,
        settledAt: "2026-06-25T10:48:56Z",
        latencyMs: 672,
      },
    ],
    uptime: [
  ...
  },
  {
    ...
    exampleResponse: {
      ...
      score: 12,
      action: "allow",
      signals: ["known-counterparty"],
    },
    receiptHistory: [
      {
        id: "rcpt_sentinel_901",
        agent: "bot-3",
        amountXlm: 0.15,
        settledAt: "2026-06-25T09:12:37Z",
        latencyMs: 205,
      },
      {
        id: "rcpt_sentinel_900",
        agent: "bot-9",
        amountXlm: 0.15,
        settledAt: "2026-06-25T08:57:10Z",
        latencyMs: 226,
      },
    ],
    uptime: [
      { label: "Mon", value: 100 },
      { label: "Tue", value: 99.9 },
  ...
  },
  {
    ...
    exampleRequest: {
      ...
      extract: ["claims", "methods"],
    },
    exampleResponse: {
      claims: 8,
      citations: 31,
      replicationChecklist: ["dataset", "metrics"],
    },
    receiptHistory: [
      {
        id: "rcpt_paper_219",
        agent: "bot-4",
        amountXlm: 0.18,
        settledAt: "2026-06-24T22:33:08Z",
        latencyMs: 944,
      },
      {
        id: "rcpt_paper_218",
        agent: "bot-10",
        amountXlm: 0.18,
        settledAt: "2026-06-24T21:14:50Z",
        latencyMs: 1001,
      },
    ],
    uptime: [
      { label: "Mon", value: 99.0 },
      { label: "Tue", value: 98.7 },
      { label: "Wed", value: 97.8 },
      { label: "Thu", value: 96.2 },
      { label: "Fri", value: 94.5 },
    ],
  },
];
...
export function listMarketplaceServices(): MarketplaceService[] {
  ...
  return baseServices.map((service, index) => {
    const agent =
      agents.find((candidate) => candidate.district === service.district) ??
      agents[index];
    return {
      ...service,
      providerAgent: {
...
export function getDistrictName(districtId: DistrictId): string {
  return (
    DISTRICTS.find((district) => district.id === districtId)?.name ?? districtId
  );
}
