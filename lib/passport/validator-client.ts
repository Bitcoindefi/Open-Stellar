...
export const networks = {
  testnet: {
    ...
    contractId:
      process.env.NEXT_PUBLIC_STELLAR_TESTNET_VALIDATOR_CONTRACT_ID ??
      "CDNSZUNEWFCGSPWLPDSWTENR2WPHKC34RGZQG7RJA54OPGTZGVVRFYBA",
    verifierContractId:
      process.env.NEXT_PUBLIC_STELLAR_TESTNET_VERIFIER_CONTRACT_ID ??
  ...
  mainnet: {
    ...
    contractId:
      process.env.NEXT_PUBLIC_STELLAR_MAINNET_VALIDATOR_CONTRACT_ID ?? "",
    verifierContractId:
      process.env.NEXT_PUBLIC_STELLAR_MAINNET_VERIFIER_CONTRACT_ID ?? "",
  },
} as const;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "",
