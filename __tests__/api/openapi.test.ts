...
describe("GET /api/openapi.json", () => {
  it("documents implemented agent task/rate-limit endpoints plus shared rate-limit responses", async () => {
    ...
    expect(spec.paths["/api/agents/{id}/rate-limit/status"]).toHaveProperty(
      "get",
    );
    ...
    expect(spec.paths["/api/notifications/preferences"]).toHaveProperty(
      "patch",
    );
    ...
    expect(spec.paths["/api/quests/{id}/subtasks/{subtaskId}"]).toHaveProperty(
      "patch",
    );
    expectPathParam(
