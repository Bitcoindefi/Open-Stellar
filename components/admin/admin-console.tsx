          ...
          <section className="rounded-[28px] border border-cyan-500/20 bg-slate-950/80 p-5 shadow-[0_0_0_1px_rgba(15,23,42,0.7),0_24px_80px_rgba(2,8,23,0.55)] backdrop-blur">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="grid min-w-[280px] gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
                ...
                <SignalStat
                  label="Tasks routed"
                  value={formatCompact(totalTasks * 1440)}
                  color="text-emerald-300"
                />
                <SignalStat
                  label="MRR"
                  value={`${subscriptionMrr} XLM`}
          ...
          <section className="rounded-[28px] border border-slate-800 bg-slate-950/80 p-5 shadow-[0_24px_80px_rgba(2,8,23,0.5)] backdrop-blur">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-3 font-mono text-sm text-cyan-200 sm:text-base">
                  {demoKey}
                </p>
              </div>
              <button
            ...
            <div className="mt-5 space-y-3">
              <InfoRow
                ...
                label="Scope"
                value="agent.orchestrate / payments.charge / teams.read"
              />
              <InfoRow
                icon={<Shield className="h-4 w-4" />}
                label="Mode"
                value="Subscription + monthly cap"
              />
              <InfoRow
                icon={<Wallet className="h-4 w-4" />}
                label="Remaining"
                value={`${remaining.toLocaleString()} calls`}
              />
            </div>
            ...
            <div className="mt-5 rounded-2xl border border-slate-800 bg-[#09101a] p-4">
              ...
              <p className="mt-3 font-vt323 text-lg text-slate-300">
                When the cap is reached, withX402 can return 402 again,
                throttle, or upsell the agent into a higher recurring plan.
              </p>
            </div>
          </section>
        </header>
          ...
          <section className="rounded-[28px] border border-cyan-500/20 bg-slate-950/60 p-5">
            <div className="mb-5 max-w-3xl">
              ...
              <h2 className="font-pixel text-xl uppercase leading-tight text-cyan-100">
                Prove an agent is solvent &amp; authorized — without doxxing the
                owner
              </h2>
              <p className="mt-3 font-vt323 text-xl leading-7 text-slate-300">
                Each agent mints a ZK passport (Groth16 / Soroban) proving it is
                backed by a verified human and is solvent for its spend cap. The
                x402 settlement rail then releases a payment only when the agent
                holds a valid passport and the amount stays within its proven,
                hidden cap.
              </p>
            </div>
            <PassportPanel />
              ...
              >
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-950/70 p-4">
                  ...
                  <p className="mt-3 font-vt323 text-lg leading-6 text-slate-300">
                    Monthly subscription buys access to orchestration control
                    plus the x402 payment extension. Request volume is the
                    primary limiter, not seats.
                  </p>
                </div>
              </Panel>
    ...
    <section className="rounded-[28px] border border-cyan-500/20 bg-slate-950/60 p-5">
      <div className="mb-5 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="mt-3 font-vt323 text-xl leading-7 text-slate-300">
            Last 50 settled x402 receipts from the receipt database, including
            agent, service, amount, and timestamp.
          </p>
        </div>
        <button
          type="button"
