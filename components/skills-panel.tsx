...
function SkillCard({
  ...
  const remainingXp =
    upgradeState.cost === null ? 0 : Math.max(0, upgradeState.cost - skill.xp);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontFamily: "monospace", fontSize: 10, color: "#64748b" }}
        >
          Lv.{skill.level}
        </span>
      </div>
      ...
      {skill.level < skill.maxLevel && (
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span
              style={{ fontFamily: "monospace", fontSize: 9, color: "#475569" }}
            >
          ...
          >
            <span
              style={{
                fontFamily: "monospace",
                fontSize: 9,
                color: upgradeState.canUpgrade ? "#34d399" : "#64748b",
              }}
            >
              {upgradeState.canUpgrade
                ? `Ready / ${upgradeState.xpAfterUpgrade} XP left`
                : `${remainingXp} XP needed`}
            </span>
            <button
              type="button"
        ...
        >
          <div
            style={{
              width:
                agentXpToNext > 0
                  ? `${Math.min(100, Math.round((agentXp / agentXpToNext) * 100))}%`
                  : "100%",
              height: "100%",
              background: selectedAgent.color,
              transition: "width 0.45s ease-out",
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              {
                selectedAgent.skills.filter((sk) => sk.level >= sk.maxLevel)
                  .length
              }
