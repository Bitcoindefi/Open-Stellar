    ...
    <aside className="w-80 border-l bg-card flex flex-col gap-6 p-5 overflow-y-auto">
      ...
      <section className="flex flex-col gap-3">
        ...
        <form onSubmit={handleCreate} className="flex flex-col gap-2">
          ...
          <button
            type="submit"
            className="rounded bg-blue-600 text-white px-3 py-2 text-sm font-medium hover:bg-blue-700"
          >
            Create Agent
          </button>
        </form>
      ...
      <section className="flex flex-col gap-3 border-t pt-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {stat(
            "Moving",
            agents.filter((a) => a.status === "moving").length,
            "text-amber-500",
          )}
          {stat(
            "Working",
