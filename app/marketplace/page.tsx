...
export const metadata: Metadata = {
  ...
  description:
    "Discover x402 agent services registered with Open Stellar providers.",
};
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_360px] lg:items-end">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-6 text-slate-400 md:text-base">
                Browse provider APIs that accept x402 payments on Open Stellar.
                Compare price, district ownership, live status, receipts served,
                latency, and reputation before wiring a service into your agent
                workflow.
              </p>
            </div>
