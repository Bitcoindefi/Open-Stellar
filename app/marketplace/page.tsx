...
export const metadata: Metadata = {
  title: 'Agentic City Marketplace',
  description: 'Discover x402 agent services registered with Agentic City providers.',
}
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_360px] lg:items-end">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-6 text-slate-400 md:text-base">
                Browse provider APIs that accept x402 payments on Agentic City. Compare price, district ownership,
