    ...
    <main className="min-h-screen bg-[#030712] px-4 py-8 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-6">
          ...
          <h1 className="font-mono text-3xl font-bold uppercase text-cyan-100">
            Payment Explorer
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-400">
            Public receipt history for x402 settlements recorded by this Open
            Stellar instance. Use the API at{" "}
            <code className="text-cyan-200">/api/explorer/receipts</code> for
            the same paginated data.
          </p>
        </div>
