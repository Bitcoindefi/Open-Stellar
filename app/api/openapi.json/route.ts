...
const spec = {
  openapi: "3.1.0",
  info: { title: "Agentic City API", version: "0.2.0", description: "Developer API for Agentic City agents, x402 payments, ZK Passport, reputation, Stellar helpers, feeds, and admin workflows." },
  servers: [{ url: "https://agentic-city.vercel.app", description: "Public Agentic City deployment" }],
  tags: [
