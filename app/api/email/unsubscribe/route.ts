...
export async function GET(req: Request) {
  ...
  return new NextResponse(
    `<!doctype html><html><body style="font-family: Arial, sans-serif"><h1>Unsubscribed</h1><p>${email} will no longer receive Agent Arena email notifications.</p></body></html>`,
